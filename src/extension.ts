  ...
  context.subscriptions.push(
    vscode.languages.registerHoverProvider("javascript", {
      provideHover(document, position, token) {
        ...
        let endBracket: number = line.text.indexOf("]", index);
        ...
        if (
          ...
          foundText = foundText.trim().toLowerCase();

          switch (foundText) {
            case "voice":
              hoverTextArr.push(new vscode.MarkdownString("*voice*"));
              hoverTextArr.push(
                new vscode.MarkdownString("Alexa: _supported_")
              );
              hoverTextArr.push(
                new vscode.MarkdownString("Google: _not supported_")
              );
              break;
            case "whisper":
              hoverTextArr.push(new vscode.MarkdownString("*whisper*"));
              hoverTextArr.push(
                new vscode.MarkdownString("Alexa: _supported_")
              );
              hoverTextArr.push(
                new vscode.MarkdownString("Google: _supported_")
              );

              break;
            case "emphasis":
              hoverTextArr.push(new vscode.MarkdownString("*emphasis*"));
              hoverTextArr.push(
                new vscode.MarkdownString("Alexa: _supported_")
              );
              hoverTextArr.push(
